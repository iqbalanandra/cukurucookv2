        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-auto">
                        <img class="h-8 w-auto" src="{{ asset('images/CukurucookLogo.png') }}" alt="Cukurucook">
                    </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <a class="font-medium" href="">{{ Auth::user()->username }}</a>
                        <!-- Profile dropdown -->
                        <div class="relative ml-3">
                            <div>
                                <button type="button" @click="isOpen = !isOpen"
                                    class="relative flex max-w-xs items-center rounded-full bg-yellow-300 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-yellow-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    <span class="absolute -inset-1.5"></span>
                                    <span class="sr-only">Open user menu</span>
                                    <img class="h-8 w-8 rounded-full" src="{{ Auth::user()->profilePicture ? asset('uploads/profile_pictures/' . Auth::user()->profilePicture) : asset('images/default-profile.png') }}" alt="">
                                </button>
                            </div>
